...
public class LineChartBill extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line_chart_bill);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(LineChartBill.this,DashBoardActivity.class);
        ...
        imgOption.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popup = new PopupMenu(LineChartBill.this,v);
...
//....................
        ...
        xAxis.setValueFormatter(new LineChartBill.MyAxisValueFormatter(values));
    ...
    private void openmonthlycharts(){
        Intent i = new Intent(this, LineChartBillMonthly.class);
        startActivity(i);
    }
                                ...
                                for (int i=1;i<=30;i++) {
                                    ...
                                    for (int b=0;b<daily.size();b++){
                                        if (i == daily.get(b).getDate()&&year==daily.get(b).getYear()&&month==daily.get(b).getMonth()) {
                                            if(daily.get(b).getTime_spand()==14||daily.get(b).getTime_spand()==15||daily.get(b).getTime_spand()==16||daily.get(b).getTime_spand()==17) {
...
//+1 Is Important Because if the month is January then coming 0 so Add +1
        ...
        daily.add(new GetPowerMonth_Model(month,power,year,date,time_id));
    }
    }
