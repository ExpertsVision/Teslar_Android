...
public class DataSqlite {
    ...
    public DataSqlite(String s){}

    public DataSqlite(int _id,String system_id, String date, int timespan, int total_power_ac, int total_power_dc, int voltage_ac, int current_ac, int voltage_dc, int current_dc, int humidity, int temperature) {
        this._id = _id;
